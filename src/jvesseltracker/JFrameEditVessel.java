...
public class JFrameEditVessel extends javax.swing.JFrame {

    public JFrameEditVessel() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEditVessel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ...
            new JFrameEditVessel().setVisible(true);
